//We shall fiddle around for the project here. 
...
hangman = function()
{
    ...
    //List of words
    movies = ["Dune", "Titanic", "Interstellar", "Dunkirk", "Joker", "Inception"]

    places = ["Toronto", "Ottawa", "Montreal", "Vancouver", "Calgary", "Windsor"]

    countries = ["Pakistan", "Canada", "USA", "France", "Japan", "Brazil"]
